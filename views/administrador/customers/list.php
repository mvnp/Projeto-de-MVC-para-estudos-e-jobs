...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lista de Clientes
        <small><a href="<?php echo URL ?>customers/add">Cadastrar cliente (<?php echo $this->count ?>)</a></small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <?php foreach ($this->getList as $business => $emp): ?>
                  <tr>
                    <td style="width: 10px"><?php echo $emp['id'] ?></td>
                    <td><?php echo $emp['fantasia'] ?></td>
                    <td><?php echo $emp['endereco'] .', '. $emp['numero'] ?></td>
                    <td><?php echo $emp['telefone'] ?></td>
                    <td><?php echo "<a target='_blank' href='https://wa.me/55".str_replace(" ", "", str_replace("(", "", str_replace(")", "", str_replace(")", "", str_replace("-", "", $emp['whatsapp'])))))."'>".$emp['whatsapp']."</a>" ?></td>
                    <td style="width: 40px"><a href="<?php echo URL . 'customers/edit/' . $emp['id'] ?>">Editar</a></td>
                    <td style="width: 40px"><a onclick="javascript: return confirm('Deseja realmente excluir este registro?');" href="<?php echo URL . 'customers/del/' . $emp['id'] ?>">Delete</a></td>
                  </tr>
                <?php endforeach ?>
              </table>
            </div>
