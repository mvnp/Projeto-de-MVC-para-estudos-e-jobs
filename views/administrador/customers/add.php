...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cadastrar cliente
        <small><a href="<?php echo URL ?>customers/list">Listar clientes</a></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <span style="color:red;font-size:13px">Pelo menos 20 registros por hora !!</span></a></li>
      </ol>
    </section>
            ...
            <form method="post" id="acao" class="form-horizontal" autocomplete="off">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="fantasia" class="requiredM form-control" id="fantasia" placeholder="Nome fantasia" autocomplete="off" required />
                  </div>
                  <div class="col-sm-3">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="razao" class="recommendedM form-control" id="razao" placeholder="Insira uma rede social da empresa" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="responsavel" class="form-control" id="responsavel" placeholder="Nome do responsável" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="email" class="recommendedM form-control" id="email" placeholder="E-mail da empresa" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="website" class="recommendedM form-control" id="website" placeholder="Website da empresa ou facebook ou instagram" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cnpj" class="form-control" id="cnpj" placeholder="Número do CNPJ" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="telefone" class="recommendedM form-control" id="telefone" placeholder="Número de telefone comercial" autocomplete="off" value="" />
                  </div>
                  <div class="col-sm-4">
                    <input type="text" name="whatsapp" class="requiredM form-control" id="whatsapp" placeholder="Número do Whatsapp" autocomplete="off" required value="" />
                  </div>
                </div>

                <div class="box-header with-border" style="margin-bottom:10px">
                  <h3 class="box-title">Endereço completo</h3>
                </div>

                <div class="form-group">
                  <label for="cep" class="col-sm-3 control-label">CEP</label>
                  <div class="col-sm-9">
                    <input type="text" name="cep" class="requiredM form-control" id="cep" placeholder="CEP do endereço da empresa" autocomplete="off" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" id="logradouro" name="endereco" class="requiredM form-control" id="endereco" placeholder="Rua, Avenida ou outro sem número" autocomplete="off" required />
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="numero" class="requiredM form-control" id="numero" placeholder="Número" autocomplete="off" required />
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="complemento" class="form-control" id="complemento" placeholder="Complemento" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" id="bairro" name="bairro" class="requiredM form-control" id="endereco" placeholder="Preencher bairro" autocomplete="off" required />
                  </div>
                  <div class="col-sm-3">
                    <input type="text" id="localidade" name="cidade" class="requiredM form-control" id="cidade" placeholder="Preencher cidade" autocomplete="off" required />
                  </div>
                  <div class="col-sm-3">
                    <input type="text" id="uf" name="estado" class="requiredM form-control" id="estado" placeholder="Preencher estado" autocomplete="off" required />
