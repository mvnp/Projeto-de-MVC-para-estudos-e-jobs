    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="<?php echo URL ?>adminlte/mailbox">Inbox
                <span class="pull-right-container">
            ...
            <li class="active"><a href="<?php echo URL ?>/adminlte/readmail">Read</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php echo URL ?>adminlte/mailbox"><i class="fa fa-inbox"></i> Inbox
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<?php echo PUBLIC_URL ?>img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<?php echo PUBLIC_URL ?>img/photo2.png" alt="Attachment"></span>
